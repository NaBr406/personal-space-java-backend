...
public class AuthService {
    ...
    public AuthService(AuthRepository authRepository, CaptchaService captchaService, AppProperties appProperties, AdminService adminService) {
    ...
    public UserAuthView register(RegisterRequest request, String clientIp) {
        if (!adminService.isSettingEnabled("allow_register", true)) {
            throw new ApiException(HttpStatus.FORBIDDEN, "当前已关闭注册");
        }
